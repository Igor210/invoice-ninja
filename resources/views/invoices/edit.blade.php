...
@section('content')
	...
	<div class="table-responsive" style="padding-top:4px;">
		...
		<table class="@if(trans('texts.direction')!='rtl') pull-right @else pull-left @endif subtotals-table" style="margin-right:40px; margin-top:0px;">
			<tr>
		...
		<div role="tabpanel" class="@if(trans('texts.direction')!='rtl') pull-left @else pull-right @endif" style="margin-left:40px; margin-top:30px;">
